...
export default async function CertificatesPage() {
  ...
  const { data } = await db.from("digital_certificates").select("id,organization_id,owner_tax_id,status,subject,valid_until,organizations(legal_name)").is("replaced_at", null).order("valid_until");
