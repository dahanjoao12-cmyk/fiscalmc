...
export async function POST(request:Request){
  ...
  try{
    ...
    logEvent("error","INVOICE_REQUEST_FAILED",{requestId,...issuanceFailureDiagnostic(stage,error)});
